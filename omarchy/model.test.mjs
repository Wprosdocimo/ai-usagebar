...
assert.match(settingsViewSource, /function\s+orderedKeys\s*\(/);
assert.match(settingsViewSource, /model:\s*root\.keyEntries/);
assert.match(settingsViewSource, /opencode-go/);
